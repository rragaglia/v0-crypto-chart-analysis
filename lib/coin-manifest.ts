...
export const COIN_MANIFEST: CoinMeta[] = [
  ...
  { id: "matic-network",      symbol: "MATIC",  name: "Polygon",            hyperliquidSymbol: "MATIC",  binanceSymbol: "MATIC",  image: "https://assets.coingecko.com/coins/images/4713/small/matic-token-icon.png" },
